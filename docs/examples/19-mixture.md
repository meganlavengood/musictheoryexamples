...
<table class="tablesaw tablesaw-stack" data-tablesaw-mode="stack">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="19-mixture/mixa.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixc.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
      <td><a href="19-mixture/mixc.pdf">{% octicon file height:16 aria-label:pdf %}</a></td>
    </tr>
    <tr>
      <td>Schubert, &quot;Du bist die Ruh,&quot; mm. 25-30</td>
      <td><a href="19-mixture/mixd.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixf.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
...
<table class="tablesaw tablesaw-stack" data-tablesaw-mode="stack">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixj.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixk.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixl.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixn.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixo.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixp.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixq.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
      <td><a href="19-mixture/mixq.pdf">{% octicon file height:16 aria-label:pdf %}</a></td>
    </tr>
    <tr>
      <td>Paradis, Sicilienne, mm. 1-6</td>
      <td><a href="19-mixture/mixr.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixs.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixt.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixu.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixv.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
      <td><a href="19-mixture/mixv.pdf">{% octicon file height:16 aria-label:pdf %}</a></td>
    </tr>
    <tr>
      <td>Gershwin, Rhapsody in Blue, mm. 1-6</td>
      <td><a href="19-mixture/mixw.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixx.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixy.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixz.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
...
<table class="tablesaw tablesaw-stack" data-tablesaw-mode="stack">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixg1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
      <td></td>
    </tr>
    <tr>
      <td>Beethoven, String Quartet in c minor, op. 16 no. 4, mvt. 4 (end) <strong>sound only</strong></td>
      <td><a href="19-mixture/mixh1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
      <td></td>
    </tr>
    <tr>
      <td></td>
...
<table class="tablesaw tablesaw-stack" data-tablesaw-mode="stack">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="19-mixture/mixk1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixl1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixm1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a> </td>
...
<table class="tablesaw tablesaw-stack" data-tablesaw-mode="stack">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="19-mixture/mixq1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
    ...
    <tr>
      ...
      <td><a href="19-mixture/mixr1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a></td>
      <td><a href="19-mixture/mixr1.pdf">{% octicon file height:16 aria-label:pdf %}</a></td>
    </tr>
    <tr>
      <td>Walton, Viola Concerto, mvt. 3, mm. 297-301</td>
      <td><a href="19-mixture/mixs1.mp3">{% octicon unmute height:16 aria-label:mp3 %}</a> </td>
